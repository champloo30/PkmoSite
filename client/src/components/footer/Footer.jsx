...
export default function Footer() {
    return (
        <div className="footer" id="footer">
            ...
            <a href="http://www.facebook.com/pkmohio" target="_blank" rel="noopener noreferrer" aria-label="Peace K M O Facebook Page">
                <img className="icon" src={facebook} alt="Facebook Logo" />
            </a>
            <a href="http://www.youtube.com/@PeaceKingdomMinistriesofOhio" target="_blank" rel="noopener noreferrer" aria-label="Peace K M O Youtube Page">
