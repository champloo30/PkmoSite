        ...
        <>
            <div className="connect">
                ...
                <div className="p-text">
                    ...
                    <p>Just fill out the form and we'll get you in touch with the right people to provide the right service that you need!</p>
                </div>
                <div className="formbox">
                    <form className="form" action="" method="post">
                        <h3>Get Connect With the Kigdom</h3>
                        <div className="form-name">
                            <div className="fname">
                                <label htmlFor="fname">First Name</label><br />
                                <input type="text" name="fname" id="lname" placeholder="John"/><br />
                            </div>
                            <div className="lname">
                        ...
                        <div className="phone-email">
                            ...
                            <div>
                                <div className="phone">
                                    <div className="label">
                                        <input className="checkbox" type="checkbox" name="phone-email" id="phone" value="Phone" />
